...
def parse_opt():
    ...
    parser.add_argument('--input_fc_dir', type=str,
                        default='/data/scene_understanding/bottom-up-feature/adaptive/cocobu_fc',
                        help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str,
                        default='/data/scene_understanding/bottom-up-feature/adaptive/cocobu_att',
                        help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str,
                        default='/data/scene_understanding/bottom-up-feature/adaptive/cocobu_box',
    ...
    parser.add_argument('--caption_model', type=str, default="vaeaoa",
                        help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer,aoa,vaeaoa')
...
def add_eval_options(parser):
    ...
    # Sampling options
    parser.add_argument('--sample_quantity', type=int, default=2,
                        help='sample quantity of diversity seq')
